run_analysis
============
Last updated 2015-03-22 23:48:17 using R version 3.1.2 (2014-10-31).
...
```
## [1] "C:/GitHub/getting-cleaning-data"
```
...
Download the file. Put it in the `Data` folder of your Assignment Directory. 
...
**See the `README.txt` file in C:/GitHub/getting-cleaning-data for detailed information on the dataset.**
